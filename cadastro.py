...
#--------------------------------------INTERFACE------------------------------------------------#
        ...
        Label(self.frame1,text='Nome',font=('Ariel','15')).place(relx=0.02,rely=0.12)
        ...
        Label(self.frame1,text='Telefone',font=('Ariel','15')).place(relx=0.02,rely=0.31)
        self.fone = Entry(self.frame1,font=('Ariel','20'))
        self.fone.place(relx=0.02,rely=0.36,width=200)
        Label(self.frame1,text='Complemento',font=('Ariel','15'),bg='yellow').place(relx=0.02,rely=0.50)
        ...
        self.frame2 = Frame(master,bg='grey')
